...
![Dimentionality](../images/Fortran_Tutorial/fig1.JPG)

According to the General Structure (GS), the number of entries in each dimension is specified as follows:

One-dimensional (Line):   

![1D](../images/Fortran_Tutorial/fig2.JPG)

Two-dimensional (Plane):   

![2D](../images/Fortran_Tutorial/fig3.JPG)

Three-dimensional (Volume):

![3D](../images/Fortran_Tutorial/fig4.JPG)
...
![4D](../images/Fortran_Tutorial/fig5.JPG)
