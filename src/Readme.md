...
3. **Readable Code Structure**: See this Program only as a Regular and Readable Program    
4. **Do loop**: Types of Repetition Loops    
5. **If then else**: Types of Conditional Command    
6. **Open file**: The Method of Creating a File - Writing to the File - Reading from the File    
7. **Array**: Definition and Use of Arrays, the Programs of this Collection are Set to Introduce Various Applications of these Commands.   
